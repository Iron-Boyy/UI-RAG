...
from app_utils import print_with_color
...
if user_input == "1":
    ...
    os.system(f"python step_recorder.py --app {app} --demo {demo_name} --root_dir {root_dir}")
    os.system(f"python document_generation.py --app {app} --demo {demo_name} --root_dir {root_dir}")
